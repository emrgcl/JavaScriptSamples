    ...
    "value": [
      {
        ...
        "managedBy": "/subscriptions/0e6e9ede-e794-4d39-bd16-cdc402faee39/resourceGroups/ContosoAll/providers/Microsoft.Compute/virtualMachines/emreg-test01",
        "location": "westeurope",
        "zones": [
          "1"
        ]
...
const getResourceGroup = (id) => {
    const regex = /\/subscriptions\/[^\s/]+\/resourceGroups\/(?<resourceGroup>[^\s\/]+)/;
...
const newresources= resources.value.map((resource) => { 
    ...
    resource.tags == undefined ? formattedResource['tags'] = {} : formattedResource['tags'] = resource.tags; 
    
    return formattedResource
} )

const resourceId = '/subscriptions/0e6e9ede-e794-4d39-bd16-cdc402faee39/resourceGroups/DefaultResourceGroup-WEU/providers/Microsoft.OperationalInsights/workspaces/DefaultWorkspace-0e6e9ede-e794-4d39-bd16-cdc402faee39-WEU';
const resourceId2= '/subscriptions/0e6e9ede-e794-4d39-bd16-cdc402faee39/resourceGroups/ContosoAll/providers/Microsoft.Network/virtualNetworks/ContosoAll-vnet';
const testobject = {
    Name: 'Emre'
}
